...
class DeportePolicy
{
    ...
    {
        return isAdmin() && empty($deporte->deleted_at);
    }
     ...
     */
    public function restore(User $user, Deporte $deporte): bool
    {
        return isAdmin();
    }
     ...
     */
    public function forceDelete(User $user, Deporte $deporte): bool
    {
        return $user->is_root;
    }
}
